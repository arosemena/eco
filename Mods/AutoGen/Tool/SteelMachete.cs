...
namespace Eco.Mods.TechTree
{
    ...
    {
        // Static values
        private static IDynamicValue caloriesBurn = CreateCalorieValue(15, typeof(GatheringSkill), typeof(SteelMacheteItem), new SteelMacheteItem().UILink());
        private static IDynamicValue exp = new ConstantValue(1);
        private static IDynamicValue tier = new MultiDynamicValue(MultiDynamicOps.Sum, new ConstantValue(3), new TalentModifiedValue(typeof(GatheringToolStrengthTalent), 0));
